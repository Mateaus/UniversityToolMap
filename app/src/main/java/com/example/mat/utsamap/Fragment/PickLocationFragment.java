 ...
 * {@link PickLocationFragment.PickLocationFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PickLocationFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PickLocationFragment extends Fragment implements View.OnClickListener {
    ...
    private Button pnbButton, mhButton, msButton, flnButton, jplButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pnbButton = (Button)v.findViewById(R.id.npbBtn);
        mhButton = (Button)v.findViewById(R.id.mhBtn);
        msButton = (Button)v.findViewById(R.id.msBtn);
        flnButton = (Button)v.findViewById(R.id.flnBtn);
        jplButton = (Button)v.findViewById(R.id.jplBtn);

        //getFragmentManager().popBackStackImmediate(); // it's to return to previous fragment

        pnbButton.setOnClickListener(this);
        mhButton.setOnClickListener(this);
        msButton.setOnClickListener(this);
        flnButton.setOnClickListener(this);
        jplButton.setOnClickListener(this);
    ...
    private void loadMapLocationFragment(String location) {
        MainActivity mainActivity = (MainActivity)getActivity();
        Log.e(TAG, "Data inside loadMapLocationFragment ");
        mainActivity.loadLocationFragmentScreen(location);
    }

    // TODO: Rename method, update argument and hook method into UI event
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onPickLocationFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof PickLocationFragmentInteractionListener) {
            mListener = (PickLocationFragmentInteractionListener) context;
        } else {
    ...
    public interface PickLocationFragmentInteractionListener {
        ...
        void onPickLocationFragmentInteraction(Uri uri);
    }
}
